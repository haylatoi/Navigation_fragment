...
public class List_giaonhanh extends Fragment {
    ListView listView;
    Spinner spinner;

    int imgs[]={R.drawable.comli7,R.drawable.comli6,R.drawable.comli3,R.drawable.comli1};
    String tenQuan[]={"Quán cơm sinh viên","Cơm Đại","Cơm sườn","Cơm Tấm Cao Thắng"};
    String diachi[]={"48 Cao Thắng","02 Thanh Sơn","13 ông ích khiêm","25 Cao Thắng"};
    ...
    public static List_giaonhanh newInstance(String param1, String param2) {
        List_giaonhanh fragment = new List_giaonhanh();
